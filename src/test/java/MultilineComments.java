...
public class MultilineComments extends TokenTester {
    ...
    public void simpleTest() {
        List<Token> tokens = new ClassicTokenizer().toTokenList("token1 token2 /* This is comment! token3 */ token4");
    ...
    public void parsingWithoutClosingSequenceTest() {
        new ClassicTokenizer().toTokenList("token1 token2 /* This is comment! token3 token4");
    }
}
